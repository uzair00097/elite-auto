...
export default function VehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const whatsappNumber = "923000000000"; // placeholder seller contact
        ...
        <div className="md:col-span-2">
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm md:sticky md:top-20">
            ...
            <a
              ...
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700"
            >
